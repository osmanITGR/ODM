...
/// to its next source rather than saving a file called "_".
String _sanitiseFilename(String name) {
  ...
  // "/" sanitises to "_", which is non-empty but carries no information.
  if (RegExp(r'^_+$').hasMatch(cleaned)) return '';
